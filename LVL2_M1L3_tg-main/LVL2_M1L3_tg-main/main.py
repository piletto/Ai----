...
bot = telebot.TeleBot("8364282047:AAFVFjRzwIz5C6xaOvWyqWyTJn-Ue8C_rDw")
...
def photo(message):
    ...
    result = get_class(model_path="Путь к модели", labels_path="путь к меткам", image_path="Путь к картинке")
